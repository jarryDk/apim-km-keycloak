        ...
        public List<ConfigurationDto> getConnectionConfigurations() {
                ...
                configurationDtoList
                                .add(new ConfigurationDto(//
                                                ...
                                                "Client Secret", //
                                                "input", //
                                                "Client Secret of service Application", //
                                                "", //
                                                true, //
                                                true, //
                                                Collections.emptyList(), //
        ...
        public List<ConfigurationDto> getApplicationConfigurations() {
                ...
                configurationDtoList.add(//
                                new ConfigurationDto(//
                                                ...
                                                "Response Type", //
                                                "select",
                                                "Type Of Token response", //
                                                Arrays.asList("token"), //
                                                false, //
                                                false, //
                                                Arrays.asList("code", "none", "id_token", "token",
                                                                "id_token token",
                                                                "code id_token",
                ...
                configurationDtoList.add(//
                                new ConfigurationDto(//
                                                ...
                                                false));
                configurationDtoList.add(//
                                new ConfigurationDto("token_endpoint_auth_method",
                                                "Token endpoint Authentication Method",
                                                "select", "How to Authenticate Token Endpoint",
                                                "client_secret_basic",
                                                true,
                                                false,
                                                Arrays.asList("private_key_jwt", "client_secret_basic",
                ...
                configurationDtoList.add(//
                                new ConfigurationDto(//
                                                ...
                                                "select", //
                                                "Generate Certificate Bound Oauth2 Token", //
                                                "false", //
                                                true,
                                                false, //
